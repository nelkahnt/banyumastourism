...
class wstBuatan : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.wst_buatan)
        setTitle("Wisata Buatan")
    ...
    private fun getData() {
        ...
        fbFirestore.collection("wstbuatan").orderBy("name", Query.Direction.ASCENDING)
