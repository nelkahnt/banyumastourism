...
class wstAlam : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.wst_alam)
        setTitle("Wisata Alam")
    ...
    private fun getData() {
        ...
        fbFirestore.collection("wstalam").orderBy("name", Query.Direction.ASCENDING)
